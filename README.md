...
- **閲覧**: 全ユーザー（ログイン不要）
- **編集**: 管理者（`r06hgunews@gmail.com` でログインしたユーザーのみ）
...
2. **管理者の確立**
   管理用アプリ側で Firebase Authentication (Googleログイン等) を実装し、`r06hgunews@gmail.com` でログインしてください。ログインすることで、Firestoreへの書き込み権限が付与されます。
