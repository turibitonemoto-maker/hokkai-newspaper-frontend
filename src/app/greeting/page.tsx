...
export default function GreetingPage() {
  ...
  const displayAuthorImageUrl = useMemo(() => getDisplayImageUrl(greeting?.authorImageUrl), [greeting?.authorImageUrl]);
      ...
      <div className="max-w-3xl mx-auto space-y-20">
        ...
        <div className="space-y-16">
          <div className="flex justify-center">
            <div className="w-64 h-80 relative rounded-[48px] overflow-hidden shadow-2xl bg-slate-50 ring-4 md:ring-8 ring-white">
              {displayAuthorImageUrl ? (
                <Image
                  ...
                  priority
                  unoptimized={displayAuthorImageUrl.includes('drive.google.com')}
                />
              ) : (
          ...
          <div className="space-y-12">
            <h2 className="text-2xl md:text-4xl font-black tracking-tight text-slate-950 text-center leading-tight px-4">
              {greeting.title}
            </h2>
            <div 
              className={cn(
                "prose prose-slate max-w-none font-medium text-slate-700 mx-auto tracking-wide px-4",
                "prose-p:leading-6 prose-p:my-3 prose-p:text-base md:prose-p:text-lg",
                "md:prose-lg"
              )}
